...
-(void)updateNavigationItems{
    if (_isShowCloseBtn) {
        if (self.webView.canGoBack) {
            ...
            [self addNavigationItemWithImageNames:@[@"back_icon_left",@"close_icon"] isLeft:YES target:self action:@selector(leftBtnClick:) tags:@[@2000,@2001]];
...
//                [self addNavigationItemWithImageNames:@[@"back_icon_left"] isLeft:YES target:self action:@selector(leftBtnClick:) tags:@[@2001]];
//            }
        }
    }
}
